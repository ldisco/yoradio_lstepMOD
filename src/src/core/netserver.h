...
<head>
  ...
  <script type="text/javascript" src="variables.js"></script>
  <script type="text/javascript" src="script.js?v=14"></script>
  <script type="text/javascript" src="dragpl.js?v=4"></script>
  </head>
<body>
...
<div id="heap"></div>
<div id="cpubar" class="hidden"></div>
</body>
</html>
)";
